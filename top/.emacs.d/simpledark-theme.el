;;; simpledark.el --- A dark Emacs 24 theme for your focused hacking sessions
...
;;
;;     M-x load-theme RET simpledark RET
;;
;; or put in your init file
;;
;;     (load-theme 'simpledark)
;;
...
(let ((class '((class color) (min-colors 10)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face ((,class (:slant italic :foreground ,ddgray))))
